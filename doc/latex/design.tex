...
This section describes the overall game design. Firstly an detailed view
...
user interface which, in any case, is detailed and illustrated in section 7.
Thirdly, and finally, a detailed list of the graphics and animations that
will be needed in the final version.
...
&This profile will be shown as marked in 7.1.1.B
\\B
&Profile name.
&
\\C
&Cancel button:
&Back to 7.1.1 without changes
\\D
&Ok button
&Back to 7.1.1 with profile changes
\end{tabular}
\end{table}
